      ...
      >
        ...
        <div className="flex-1 space-y-6 overflow-y-auto px-6 py-6">
          <div className="flex items-center gap-4 rounded-xl border border-slate-200 bg-slate-50/80 p-4">
            ...
            <div className={`font-mono-num text-2xl font-bold ${isNominal || accepted ? "text-emerald-700" : "text-rose-700"}`}>
          ...
          <div>
            ...
            <div className="mt-3 grid grid-cols-3 gap-3">
              <div className={`rounded-xl border p-4 shadow-xs ${isNominal || accepted ? "border-slate-200 bg-slate-50" : "border-rose-200 bg-rose-50/60"}`}>
                <div className="text-[11px] text-slate-500 font-medium">Observed {detail.parameter}</div>
                <div className={`mt-1 font-mono-num text-xl font-bold ${isNominal || accepted ? "text-slate-900" : "text-rose-700"}`}>
